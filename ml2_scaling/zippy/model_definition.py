...
def get_hip_torque(scale, safety_factor=1.0):
    SCALE_DATA = np.array([0.9,         1.0,         1.02960932,  1.17788372,  1.34751117,  1.54156673, 
                           ...
                           40,          40.486,      41,          44.535999999999994],     dtype=float)
    
    TORQUE_DATA = np.array([0.003,      0.005,       0.008,       0.009,       0.010,       0.012,       
                            0.019,      0.028,       0.044,       0.066,       0.082, 
                            0.10,       0.20,        0.30,        0.40,        0.50,  
                            0.65,       0.70,        0.72,        0.80,        1.0,         1.5,       1.6, 
                            2.3,        3.3,         4.2,         5.0,         7.4, 
                            11,         13,          22,          26,          40, 
                            55,         88,          91,          130,         197, 
                            205,        210,         220,         300],       dtype=float)
    
    POWER_ALPHA = 2.9241 # found from getting a bunch of hand tuned torque values that lead to walking
    POWER_C = 0.00409   # torque ≈ C * scale^alpha
