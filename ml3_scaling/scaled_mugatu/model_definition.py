...
def get_hip_torque(scale, safety_factor=1.0):
    SCALE_DATA = np.array([ 0.9, 1,
                           1.014, 1.03011523, 1.17904154, 1.34949849, 1.54459883,  
                           1.76790531, 2.02349576, 2.31603756, 2.65087284, 3.03411610, 
                           3.47276578, 3.97483212, 4.54948345,  5.20721354, 5.96003330, 
                           6, 6.283, 6.82169007,7.80791870, 8.93672885, 
                           10.22873387, 11.70752726, 13.40011348, 15.33740107, 17.55476713, 
                           20.09270330, 22.99755518, 26.32236869, 30.12785873, 34.48351788, 
                           39.46888547, 40, 40.486, 41.068, 42, 
                           45.175
                           ], dtype=float)
    TORQUE_DATA = np.array([
                            0.0023, 0.0025,
                            0.0026, 0.0027, 0.0034, 0.0055, 0.011, 
                            0.015, 0.03, 0.048, 0.09, 0.15, 
                            0.27, 0.41, 0.77, 1.29, 2.3, 
                            3, 4, 4.2, 6.7, 11.5, 
                            25, 38, 60, 100, 164, 
                            290, 545, 880, 1500, 3400, 
                            4180, 4400, 4650, 5000, 5500, 
                            7200 
                            ], dtype=float)
    POWER_ALPHA = 3.9595      
    POWER_C = 0.00208       
...
class ContactResultsToArray(LeafSystem):
    def __init__(
        ...
        self.DeclarePeriodicDiscreteUpdateEvent(0.001, 0, self.Publish) # 0.0001
